          ...
          <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 30, flex: 1, padding: '20px 40px', boxSizing: 'border-box', overflow: 'hidden' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 30, height: '100%', overflowY: 'auto' }}>
                <div className="fade-in" style={{ backgroundColor: 'rgba(25, 25, 25, 0.7)', borderRadius: '40px', border: `2px solid ${isEmergencyActive ? '#ff4d4d' : 'rgba(179, 255, 0, 0.4)'}`, padding: '30px', backdropFilter: 'blur(25px)', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 400, position: 'relative', overflow: 'hidden' }}>
                  <video src={ignisVideo} autoPlay loop muted playsInline className={`ignis-visual ${isEmergencyActive ? 'emergency' : ''}`} onClick={() => setShowSurvivalModal(true)} style={{ width: '60%', height: 'auto', maxWidth: 350, cursor: 'pointer', zIndex: 2, imageRendering: 'crisp-edges' }} />
